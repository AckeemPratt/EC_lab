...
public class NVPAPICaller
{
    ...
    public string APIUsername = "testuser876_api1.email.com";
    private string APIPassword = "E3YKS4JGC3XCXSPG";
    private string APISignature = "Aj6c6Xd6.usrzhW2lBGuDE8GJg6PAXHful2gsaeLwh29iixu8ZKeIb3a";
...
SIGNATURE, PWD };
    ...
    retMsg)
    {
        ...
        string returnURL = "https://localhost:44364/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44364/Checkout/CheckoutCancel.aspx";
        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "AdvanceTech";
        encoder["PAYMENTREQUEST_0_AMT"] = amt;
        encoder["PAYMENTREQUEST_0_ITEMAMT"] = amt;
        encoder["PAYMENTREQUEST_0_PAYMENTACTION"] = "Sale";
        encoder["PAYMENTREQUEST_0_CURRENCYCODE"] = "USD";
        // Get the Shopping Cart Products
        using (AdvanceTech.Logic.ShoppingCartActions myCartOrders = new
        AdvanceTech.Logic.ShoppingCartActions())
        {
