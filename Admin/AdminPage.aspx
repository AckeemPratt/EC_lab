<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="AdvanceTech.Admin.AdminPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="AdvanceTech.Models.Product"
        ...
        <p></p>
        <asp:Button ID="RemoveProductButton" CssClass="btn btn-primary" runat="server" Text="Remove Product" OnClick="RemoveProductButton_Click" CausesValidation="false" />
    ...
    <table>
        <tr>
            <td>
                <asp:Label ID="LabelEditCategory" runat="server">Category:</asp:Label></td>
            <td>
                <asp:DropDownList ID="DropDownEditCategory" runat="server"
                    ItemType="AdvanceTech.Models.Category"
                    SelectMethod="GetCategories" DataTextField="CategoryName"
                    DataValueField="CategoryID">
                </asp:DropDownList>
        ...
        <tr>
            <td>
                <asp:Label ID="LabeEditProduct" runat="server">Product:</asp:Label></td>
            <td>
                <asp:DropDownList ID="DropDownEditProduct" runat="server" ItemType="AdvanceTech.Models.Product"
                    SelectMethod="GetProducts" AppendDataBoundItems="true"
                    DataTextField="ProductName" DataValueField="ProductID">
                </asp:DropDownList>
            </td>
        ...
        <tr>
            <td>
                <asp:Label ID="LabelEditDescription" runat="server">Description:</asp:Label></td>
            <td>
                <asp:TextBox ID="EditProductDescription" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Text="* Description required." ControlToValidate="EditProductDescription" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="LabelEditPrice" runat="server">Price:</asp:Label></td>
            <td>
                <asp:TextBox ID="EditProductPrice" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" Text="* Price required." ControlToValidate="EditProductPrice" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Text="* Must be a valid price without $." ControlToValidate="EditProductPrice" SetFocusOnError="True" Display="Dynamic" ValidationExpression="^[0-9]*(\.)?[0-9]?[0-9]?$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="LabelEditProductImage" runat="server">Image File:</asp:Label></td>
            <td>
                <asp:FileUpload ID="EditProductImage" runat="server" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Text="* Image path required." ControlToValidate="EditProductImage" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
    </table>
    <p></p>
    <p></p><asp:Button ID="UpdateProductButton" CssClass="btn btn-primary" runat="server" Text="Update Product" OnClick="UpdateProductButton_Click" CausesValidation="true" />
