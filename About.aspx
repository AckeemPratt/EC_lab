<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="AdvanceTech.About" %>
...
.aboutus-title::after {
    background: #6E8989 none repeat scroll 0 0;
    bottom: 0;
    content: "";
    height: 2px;
    left: 0;
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="aboutus-banner">
                        <img  class="animated bounceIn" style="border-radius:10%;  height: 291px; width: 295px;" src="for website.png" alt="">
                    </div>
                </div>
